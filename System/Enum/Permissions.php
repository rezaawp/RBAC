...
namespace App\Extensions\RBAC\System\Enum;

use App\Enums\Traits\EnumTo;
use App\Enums\Traits\StringBackedEnumTrait;

enum Permissions: string implements \App\Enums\Contracts\WithStringBackedEnum
{
    use EnumTo;
    ...
    case HR_USR_MNGMNT = 'ext_hr_user_management';
    ...
    public function label(): string
    {
        return match ($this) {
            ...
            self::HR_USR_MNGMNT           => __('HR ; User Management'),
